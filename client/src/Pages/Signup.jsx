...
const Signup = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://anchors-full-stack-project-1.onrender.com/register', { email });
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://anchors-full-stack-project-1.onrender.com/verify-otp', { email, otp });
